...
// ==========================================
const DEFAULT_USERS = [
  { username: "nagah", role: "admin", name: "نجاح" },
  { username: "fawzy", role: "admin", name: "فوزي" },
  { username: "walid", role: "admin", name: "وليد" },
  { username: "mahmoud", role: "admin_readonly", name: "محمود" },
  { username: "roqaya", role: "staff", name: "رقية" },
  { username: "shaimaa", role: "staff", name: "شيماء" },
  { username: "wafaa", role: "staff", name: "وفاء" },
  { username: "islam", role: "staff", name: "إسلام" },
  { username: "doaa", role: "staff", name: "دعاء" },
  { username: "menna", role: "staff", name: "منة" },
];

function initializeUsers() {
  const usersPath = path.join(__dirname, "data", "db", "delta_users.json");
...
app.listen(PORT, () => {
  console.log(
    `\n✅ بوابة الدلتا للمقاولات - Server running on http://localhost:${PORT}\n`,
  );
});
